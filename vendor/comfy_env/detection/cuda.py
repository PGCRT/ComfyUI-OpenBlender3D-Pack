...
def has_nvidia_gpu() -> bool:
    ...
    try:
        r = subprocess.run(["nvidia-smi", "-L"], capture_output=True, text=True, errors='replace', timeout=5)
...
def get_cuda_from_nvcc() -> str | None:
    ...
    try:
        r = subprocess.run(["nvcc", "--version"], capture_output=True, text=True, errors='replace', timeout=5)
