...
# Boolean node (does not require CGAL, dispatches to backends)
try:
    from . import boolean
except Exception as e:
    logging.getLogger("geometrypack").warning("Boolean module unavailable: %s", e)

    class _EmptyModule:
        NODE_CLASS_MAPPINGS = {}
        NODE_DISPLAY_NAME_MAPPINGS = {}

    boolean = _EmptyModule()
...
try:
    ...
    logging.getLogger("geometrypack").warning("CGAL modules unavailable: %s", e)

    class _EmptyModule:
        NODE_CLASS_MAPPINGS = {}
        NODE_DISPLAY_NAME_MAPPINGS = {}

    reconstruction_cgal = _EmptyModule()
    remeshing_cgal = _EmptyModule()
    repair_cgal = _EmptyModule()
    decimation_cgal = _EmptyModule()
